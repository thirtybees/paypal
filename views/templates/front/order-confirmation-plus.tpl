...
<div class="confirm_PPP">
  {if $state == 'approved' || $state == 'created'}
    ...
    <form method="POST" action="" id="formConfirm">
      ...
      <input id="cancel" class="button btn btn-large" type="submit" name="confirmCancel"
             value="{l s='Cancel your order' mod='paypal'}"/>
      <input id="confirm" class="button btn btn-large" type="submit" name="confirmPayment"
